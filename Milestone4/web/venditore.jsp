...
<html>
    ...
    <div id="box"> 
        ...
        <c:if test="${inserito}">
            <h1 class="cliente_buy_success"> Oggetto creato con successo!</h1> 
        </c:if>
        ...
        <form method="post" action="Venditore_log?oggettoModificato=${oggetto.id}">
            ...
            <input id="venditore_insert" type="submit" value="Modifica" name="Submit"/>
        ...
        <form method="post" action="Venditore_log?test=1">
            <input type="hidden" name="cmd" value="oggetto">
            <!-- tutti i campi devono essere compilati (required) -->
            ...
            <input id="venditore_insert" type="submit" value="Inserisci" name="SubmitOgg"/>
            <!--<input id="venditore_delete" type="submit" value="Pulisci campi"/>-->
        </form>
       </div>    
         </c:when>
