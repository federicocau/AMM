...
<html>
    ...
    <div id="box">
        ...
        <c:if test="${oggetto_terminato}">
            <h1 class="cliente_buy_success"> Oggetto acquistato con successo! La disponibilità dell'oggetto è terminata</h1> 
        </c:if> 
        <c:if test="${comprato}">
        ...
        <!-- Tasto Ricerca -->
        <div class="ricerca">
        <label for="filtra" class="filtro">Barra di ricerca</label>
        <input type="text" id="filtra" name="filtra" id="filtra" size="15"/>
        </div>
        ...
        <div id="cliente_480table">
            ...
            <table id="on_off_480table">
                ...
                <c:if test="${oggetto.quantita > 0}">
                <tr>
                <th id ="immagine_span" rowspan="4"><img title="${oggetto.categoria}" alt="${oggetto.categoria}" src="${oggetto.url}" width="140" height="140"></th>
        ...
        <c:if test="${errore_sql}">
            <h1 class="cliente_buy_failed">Errore: eccezione SQL!</h1> 
        </c:if>
