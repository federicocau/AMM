 ...
 * @author Admin
 */
@WebServlet(name = "Filter", urlPatterns = {"/filter.json"}) // filter.json
public class Filter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command != null) 
        {
            ...
            {
                // ID professore(venditore?)
                
                // Esegue la ricerca
                ArrayList<TechwareObject> listaOggetti = TechwareObjFactory.getInstance().getSellingObjectList((request.getParameter("text")));
